...
user1 = User.create!(first_name: "John", last_name: "Doe", uin: "123456789", email: "john.doe@tamu.edu", phone_number: "123-456-7890", dob: Date.new(1990, 1, 1), points: 0, role: user_role.id)
user2 = User.create!(first_name: "Jane", last_name: "Doe", uin: "123456789", email: "jane.doe@tamu.edu", phone_number: "123-456-7890", dob: Date.new(1990, 1, 1), points: 0, role: user_role.id)